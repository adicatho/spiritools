# SpiriTools – Catholic AI

**A 100% local, open-source, faithful Catholic theological assistant**

**SpiriTools** is the artificial intelligence branch of the long-standing **Ictus Win / Biblia Clerus** project (serving the Church for over 20 years).
...
- Initial announcement, with internal workflow and feasibility probing.

## How to Contribute

Are you a priest, religious, theologian, Catholic developer, or simply a motivated layperson?
...
**AGPL-3.0** – because the treasures of the faith belong to everyone.

The ADIC (Association Diffusion Informatique Catholique) French association is responsible of the project. The leader and owner of the software part is Arnaud Bouchez.

> Project placed under the protection of the Blessed Virgin Mary. 

*Fides quaerens intellectum*  
Spiritools – December 2025
